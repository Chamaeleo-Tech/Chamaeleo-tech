...
export default function AboutHero() {
    return (
        <section
            className="w-full pt-40 pb-20 text-white relative bg-no-repeat bg-bottom bg-cover flex flex-col items-center text-center"
            style={{ backgroundImage: "url('/images/hero-bg.svg')" }}
        >
            <div className="max-w-5xl mx-auto z-10">
                <h1 className="text-5xl md:text-6xl font-bold leading-tight font-roboto mb-6">
                    About
                ...
                <p className="max-w-2xl mx-auto text-lg md:text-xl font-poppins leading-relaxed opacity-90 font-semibold">
