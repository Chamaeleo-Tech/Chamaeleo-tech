    ...
    return (
        <section className="w-full relative flex flex-col items-center">
            <Image
                ...
                priority
            />
            <div className="max-w-7xl relative z-10 w-full pt-28 pb-16 flex gap-5 items-center text-white">
                ...
                <div className="mt-6 mb-4 flex gap-2 bg-white rounded-lg p-4 w-full max-w-lg mx-auto md:mx-0 shadow-lg">
                    ...
                    />
                    <button className="bg-purple-700 px-6 py-3 rounded-md font-semibold w-3xs">
                        Book Now
                    </button>
                </div>
            </div>
